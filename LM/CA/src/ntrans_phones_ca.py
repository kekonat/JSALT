...
oovchar = open("/export/ws15-pt-data/tkekona/LM/CA/oovchar_ntrans.txt", 'w')
oovpronun = open("/export/ws15-pt-data/tkekona/LM/CA/oovpronun_ntrans.txt", 'w')
results = open("/export/ws15-pt-data/tkekona/LM/data/phones/phones_ntrans_ca.txt", 'w')
oov = {}	
...
def main():
	...
	ctextlist = "/export/ws15-pt-data/tkekona/LM/data/transcripts/names_list/ca_ntrans_transcript_names.txt"
