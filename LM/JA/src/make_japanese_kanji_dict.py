...
output_name = "/export/ws15-pt-data/tkekona/LM/JA/data/J_best_kanji_to_kana.txt"
bad_sentences = "/export/ws15-pt-data/tkekona/LM/JA/data/bad_sentences.txt"
common_pronunciations = "/export/ws15-pt-data/tkekona/LM/JA/data/common_pron.txt"
...
###############GOTTA CHECK THIS PART NEXT
	...
	for kanji, dict2 in kanji_dict.iteritems():
		...
		if first:
			...
			output.write("\t")
		output.write((kanji + "\t" + best_yomi).encode('utf-8'))
