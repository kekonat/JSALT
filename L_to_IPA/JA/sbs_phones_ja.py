...
results = open("/export/ws15-pt-data/tkekona/LM/data/phones/phones_sbs_ja.txt", 'w')
oov = {}
...
def main():
	...
	jtext = "/export/ws15-pt-data/tkekona/LM/data/transcripts/ja_sbs/japanese.txt"
	...
	toIpa(jtext.strip(), JWIDict, HKIDict, KIDict, NKIDict, CIDict)
