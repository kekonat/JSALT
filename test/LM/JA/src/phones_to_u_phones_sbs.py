...
file = codecs.open('/export/ws15-pt-data/tkekona/LM/data/phones/phones_sbs_ja.txt', 'r', 'utf-8')
output = open('/export/ws15-pt-data/tkekona/LM/data/u_phones/u_phones_sbs_ja.txt', 'w')
first = True
for line in file:
	if not first:
		output.write("\n")
