...
oovchar = open("/export/ws15-pt-data/tkekona/LM/CA/oovchar_wiki.txt", 'w')
oovpronun = open("/export/ws15-pt-data/tkekona/LM/CA/oovpronun_wiki.txt", 'w')
results = open("/export/ws15-pt-data/tkekona/LM/data/phones_wiki_ca2.txt", 'w')
oov = {}	
...
def main():
	...
	ctextlist = "/export/ws15-pt-data/tkekona/LM/data/transcripts/names_list/ca_wiki_transcript_names.txt"
