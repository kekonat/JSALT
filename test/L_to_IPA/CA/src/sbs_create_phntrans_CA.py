...
oovchar = open("/export/ws15-pt-data/tkekona/cantonese/data/oovchar.txt", 'w')
oovpronun = open("/export/ws15-pt-data/tkekona/cantonese/data/oovpronun.txt", 'w')
results = open("/export/ws15-pt-data/tkekona/cantonese/data/cntrans.txt", 'w')
oov = {}	
...
def main():
	...
	ctextlist = "/export/ws15-pt-data/tkekona/cantonese/data/ctrans_names.txt"
